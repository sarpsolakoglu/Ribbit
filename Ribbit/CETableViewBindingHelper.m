...
- (instancetype)initWithTableView:(UITableView *)tableView
                 ...
                 reuseIdentifier:(NSString *)resuseIdentifier
  ...
  if (self = [super init]) {
    ...
    [source subscribeNext:^(id x) {
      ...
      if (templateCellNib != nil) {
          ...
          _resuseIdentifier = resuseIdentifier;
      }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    id<CEReactiveView> cell = nil;
    if (_templateCell) {
         cell = [tableView dequeueReusableCellWithIdentifier:_templateCell.reuseIdentifier];
    } else {
        cell = [tableView dequeueReusableCellWithIdentifier:_resuseIdentifier];
    }
